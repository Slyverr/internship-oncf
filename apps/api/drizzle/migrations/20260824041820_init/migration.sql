...
CREATE TABLE "archival_execution_log" (
	...
	CONSTRAINT "archival_execution_log_execution_status_check" CHECK (("execution_status")::text = ANY (ARRAY['SUCCESS'::text, 'FAILED'::text, 'IN_PROGRESS'::text])),
	CONSTRAINT "archival_execution_log_triggered_by_check" CHECK (("triggered_by")::text = ANY (ARRAY['SCHEDULED'::text, 'MANUAL'::text]))
);
--> statement-breakpoint
CREATE TABLE "attributes" (
	...
	"created_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	CONSTRAINT "attributes_data_type_check" CHECK (("data_type")::text = ANY (ARRAY['string'::text, 'number'::text, 'date'::text, 'boolean'::text, 'decimal'::text]))
);
--> statement-breakpoint
CREATE TABLE "berths" (
	"id" bigserial PRIMARY KEY,
...
CREATE TABLE "claims" (
	...
	"closed_at" timestamp,
	CONSTRAINT "claims_priority_check" CHECK (("priority")::text = ANY (ARRAY['low'::text, 'medium'::text, 'high'::text, 'urgent'::text]))
);
--> statement-breakpoint
...
CREATE TABLE "dtm_integration_log" (
	...
	CONSTRAINT "dtm_integration_log_status_check" CHECK (("status")::text = ANY (ARRAY['SUCCESS'::text, 'FAILED'::text, 'TIMEOUT'::text, 'PENDING'::text]))
);
--> statement-breakpoint
...
CREATE TABLE "forecast_program_history" (
	...
	"changed_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"reason" text,
	CONSTRAINT "forecast_program_history_event_type_check" CHECK (("event_type")::text = ANY (ARRAY['CREATED'::text, 'QUANTITY_MODIFIED'::text, 'DATE_MODIFIED'::text, 'STATUS_CHANGED'::text, 'EXECUTION_RECORDED'::text, 'DELETED'::text]))
);
--> statement-breakpoint
...
CREATE TABLE "notifications" (
	...
	"created_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	CONSTRAINT "notifications_status_check" CHECK (("status")::text = ANY (ARRAY['PENDING'::text, 'SENT'::text, 'FAILED'::text, 'READ'::text]))
);
--> statement-breakpoint
...
CREATE TABLE "ports" (
	...
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	CONSTRAINT "ports_type_check" CHECK (("type")::text = ANY (ARRAY['normal'::text, 'dry'::text]))
);
--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	CONSTRAINT "users_type_check" CHECK (("type")::text = ANY (ARRAY['internal'::text, 'external'::text]))
);
--> statement-breakpoint
...
CREATE INDEX "idx_claim_comments_author" ON "claim_comments" ("author_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_claim_files_user" ON "claim_files" ("uploaded_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_claim_status_history_user" ON "claim_status_history" ("changed_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_claims_created_by_user" ON "claims" ("created_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_claims_customer_status" ON "claims" ("customer_id","status_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_claims_order_status" ON "claims" ("order_id","status_id") WHERE order_id IS NOT NULL;--> statement-breakpoint
CREATE INDEX "idx_claims_priority_status" ON "claims" ("priority","status_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_dtm_integration_log_user" ON "dtm_integration_log" ("created_by_user_id");--> statement-breakpoint
CREATE INDEX "idx_dtm_integration_log_http" ON "dtm_integration_log" ("http_status_code");--> statement-breakpoint
CREATE INDEX "idx_dtm_log_entity_date" ON "dtm_integration_log" ("related_entity_type","related_entity_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_dtm_log_failed" ON "dtm_integration_log" ("status","created_at") WHERE (status)::text = ANY (ARRAY['FAILED'::text, 'TIMEOUT'::text]);--> statement-breakpoint
CREATE INDEX "idx_dtm_log_performance" ON "dtm_integration_log" ("request_type_id","duration_ms","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_fp_history_user" ON "forecast_program_history" ("changed_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_forecast_programs_user" ON "forecast_programs" ("created_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_notifications_recipient" ON "notifications" ("recipient_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_notifications_entity_user" ON "notifications" ("related_entity_type","related_entity_id","recipient_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_order_executions_user" ON "order_executions" ("executed_by_user_id");--> statement-breakpoint
CREATE INDEX "idx_order_executions_created" ON "order_executions" ("created_at");--> statement-breakpoint
CREATE INDEX "idx_executions_order_date" ON "order_executions" ("order_id","execution_date");--> statement-breakpoint
CREATE INDEX "idx_executions_date_user" ON "order_executions" ("execution_date","executed_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_orders_created_by_user" ON "orders" ("created_by_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_station_passages_wagon_time" ON "station_passages" ("wagon_id","arrival_time");--> statement-breakpoint
...
CREATE INDEX "idx_train_tracking_train_date" ON "train_tracking" ("train_id","recorded_at");--> statement-breakpoint
...
CREATE INDEX "idx_user_activity_actor" ON "user_activity_log" ("actor_user_id");--> statement-breakpoint
...
CREATE INDEX "idx_wagon_tracking_wagon_date" ON "wagon_tracking" ("wagon_id","recorded_at");--> statement-breakpoint
...
ALTER TABLE "claim_comments" ADD CONSTRAINT "claim_comments_author_user_id_fkey" FOREIGN KEY ("author_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "claim_files" ADD CONSTRAINT "claim_files_uploaded_by_user_id_fkey" FOREIGN KEY ("uploaded_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "claim_status_history" ADD CONSTRAINT "claim_status_history_changed_by_user_id_fkey" FOREIGN KEY ("changed_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "claims" ADD CONSTRAINT "claims_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "claims" ADD CONSTRAINT "claims_closed_by_user_id_fkey" FOREIGN KEY ("closed_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "dtm_integration_log" ADD CONSTRAINT "dtm_integration_log_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "forecast_program_history" ADD CONSTRAINT "forecast_program_history_changed_by_user_id_fkey" FOREIGN KEY ("changed_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "forecast_programs" ADD CONSTRAINT "forecast_programs_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
ALTER TABLE "forecast_programs" ADD CONSTRAINT "forecast_programs_realized_by_user_id_fkey" FOREIGN KEY ("realized_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_recipient_user_id_fkey" FOREIGN KEY ("recipient_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "order_date_modifications" ADD CONSTRAINT "order_date_modifications_modified_by_user_id_fkey" FOREIGN KEY ("modified_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "order_executions" ADD CONSTRAINT "order_executions_executed_by_user_id_fkey" FOREIGN KEY ("executed_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "order_files" ADD CONSTRAINT "order_files_uploaded_by_user_id_fkey" FOREIGN KEY ("uploaded_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "orders" ADD CONSTRAINT "orders_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id");--> statement-breakpoint
...
ALTER TABLE "user_activity_log" ADD CONSTRAINT "user_activity_log_actor_user_id_fkey" FOREIGN KEY ("actor_user_id") REFERENCES "users"("id");--> statement-breakpoint
